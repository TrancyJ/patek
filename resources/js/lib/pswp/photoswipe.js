...
var _gestureStartTime,
	...
	_preventDefaultEventBehaviour = function(e, isDown) {
        ...
        // this try catch prevents error when sliding to the scrollbar in desktop mode.
	    try
	    {
	...
	_finishSwipeMainScrollGesture = function(gestureType, totalShiftDist, _releaseAnimData) {
		...
		// console.log("totalShiftDift", totalShiftDist);
	
	    //console.log("current item index", _currentItemIndex);
